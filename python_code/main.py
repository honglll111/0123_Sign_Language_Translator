...
from keypoint_tracker import LandmarkTracker
from mediapipe_util import mediapipe_detection, draw_styled_landmarks, extract_keypoints
        ...
        while True:
            if video_capture.isOpened():
                ...
                if tracker.dispose(results):
                    print("Dispose condition met: No landmarks for 20 seconds or only pose detected")
                    break
                ...
                if keypoints is not None:
                    ...
                    if len(sequence) == 30:
                        ...
                        mqtt_publisher.send_text(' '.join(sentence))
